...
DevicesDict = {"Bilt":bilt_new.Bilt,"Lock-in SR830":sr830_new.Sr830,'CryoMag4G':cryomag4g_new.Cryomag4G,"LS350":ls350_new.Ls350,'IPS120-10':ips120_new.Ips120,"Keithley 2400":keithley.Keithley,"Yokogawa GS200":yokogs200.Yokogs200,"Yokogawa 7651":yoko7651.Yoko7561,"LS331":ls331_new.Ls331,'HP3245A':HP3245A.HP3245A,'K2000':K2000.K2000,'Agilent34420':Agilent34420A.A34420A,"Euro2404":Euro2404.Euro2404}
...
class Ui_Dialog(object):
    ...
    def init_ui(self):
        ...
        #default gpib id
        self.GPIB_1.setText('ASRL10::INSTR')
    ...
    def init_variables(self):
        ...
        self.TempFileTimer.start(int(21600*1e3))#timer in ms saving only each 6h to check if ramp 2D gets better
